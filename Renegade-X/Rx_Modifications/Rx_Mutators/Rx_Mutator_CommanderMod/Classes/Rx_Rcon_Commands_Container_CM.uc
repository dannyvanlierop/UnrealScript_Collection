...
function InitRconCommands()
{
	...
	SpawnCommand(class'Rx_Rcon_Command_Kill');
		SpawnCommand(class'Rx_Rcon_Command_PUGController');
		LogInternal("Spawned PUG COntroller Command");
	...
	SpawnCommand(class'Rx_Rcon_Command_SetPrimaryCommander');
		LogInternal("Spawned a CommanderRconCommand");
