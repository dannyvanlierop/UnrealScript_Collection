class Ukill_Vehicle_Wolverine extends TS_Vehicle_Wolverine notplaceable;
...
simulated event PostBeginPlay()
{
	...
	Parent = MaterialInstanceConstant'RX_ENV_Ukill.VehicleMaterials.MI_VH_Wolverine_Reborn';
