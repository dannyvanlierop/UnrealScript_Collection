class Rx_Weapon_AdminGun extends Rx_Weapon_RepairGun;
...
/*
*    WeaponFireWaveForm=ForceFeedbackWaveform'Default__Rx_Weapon_AdminGun.ForceFeedbackWaveformShooting1'
*/

    WeaponRange=4000.0
/*
*    begin object name=FirstPersonMesh class=UDKSkeletalMeshComponent
*        Animations=AnimNodeSequence'Default__Rx_Weapon_AdminGun.FirstPersonMesh.MeshSequenceA'
*        ReplacementPrimitive=none
*    object end
*/
    // Reference: UDKSkeletalMeshComponent'Default__Rx_Weapon_AdminGun.FirstPersonMesh'
...
*    object end
*/
    // Reference: SkeletalMeshComponent'Default__Rx_Weapon_AdminGun.PickupMesh'
