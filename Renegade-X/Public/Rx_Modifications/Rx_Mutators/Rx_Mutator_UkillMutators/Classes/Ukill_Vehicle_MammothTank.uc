class Ukill_Vehicle_MammothTank extends RX_Vehicle_MammothTank notplaceable;
...
simulated event PostBeginPlay()
{
	...
	Parent = MaterialInstanceConstant'RX_ENV_Ukill.VehicleMaterials.MI_VH_MammothTank';
